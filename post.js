...
export default withRouter(class extends React.Component {
  static async getInitialProps({ query }) {
    ...
    .then(function (response) {
      return .keyBy(.filter(response.data.data.getObjects.objects, { type: 'globals' }), 'slug')
    })
          ...
          <div className="card-padding">
            ...
            </h2>
            {
              ...
              <div>
                ...
                <div className="blog_teaser droid" dangerouslySetInnerHTML={{_html: this.props.cosmic.post.content}}></div>
              </div>
            }
          </div>
        </main>
